...
public class Search {
  ...
  //       }
    ...
    private int checkMobility(int[][] board,Point p,Phasing ph){
        // int empty = 0;
        // int size = 8;
        // //敵の番号を識別
        // int enemyNo;
        ...
        // //上
        // if(board[p.x][p.y-1] == enemyNo){
        //     x = p.x;
        //     y = p.y-2;
        //     while(y < size && board[x][y] == enemyNo){y--;}
        //     if(board[x][y] == myNo) dir |= UPPER;
        // }
        ...
        //     x = p.x;
        //     y = p.y+2;
        //     while(board[x][y] == enemyNo){y++;}
        //     if(board[x][y] == myNo) dir |= LOWER;
        // }
